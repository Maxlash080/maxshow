...
window.unlockBodyScroll = () => {
    ...
    const openModals = document.querySelectorAll(
        '#booking-modal:not(.hidden), #user-details-modal:not(.hidden), #editor-modal:not(.hidden), #edit-profile-modal:not(.hidden), #maxshow-confirm-modal:not(.hidden), #filter-modal:not(.hidden)'
    );
...
(() => {
    const modalIds = ['booking-modal', 'user-details-modal', 'editor-modal', 'edit-profile-modal', 'maxshow-confirm-modal', 'filter-modal'];
